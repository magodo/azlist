...
func (client *Client) Resources(ctx context.Context, query armresourcegraph.QueryRequest, options *armresourcegraph.ClientResourcesOptions) (armresourcegraph.ClientResourcesResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return armresourcegraph.ClientResourcesResponse{}, runtime.NewResponseError(resp)
	}
	return client.resourcesHandleResponse(resp)
}

// resourcesCreateRequest creates the Resources request.
func (client *Client) resourcesCreateRequest(ctx context.Context, query armresourcegraph.QueryRequest, options *armresourcegraph.ClientResourcesOptions) (*policy.Request, error) {
...
func (client *Client) resourcesHandleResponse(resp *http.Response) (armresourcegraph.ClientResourcesResponse, error) {
